    ...
    children: [
      {
        path: '',
        /**
         * 访问 /admin 的落地页：数据统计（批次 5.5.3 决策 2 改的，原为商品审核）
         *
         * 理由：5.5 完成后仪表盘已是完整功能（概览 4 卡片 + 分布 2 图 + 趋势 + 热门榜），
         * 管理员进后台的第一诉求是"整体盘子有多大、最近在发生什么"，而不是直接扎进待办队列；
         * 待办在侧边栏第二项，点一下就到。侧边栏「数据统计」本来就排第一（5.5.1），
         * 落地页与菜单顺序这下是一致的。
         *
         * ⚠️ 另一处等价入口：学生侧顶栏的「管理后台」下拉项（AppHeader.vue），
         *    本批已同步改为 admin-dashboard —— 否则同一个"进后台"动作会有两个落点。
         */
        redirect: { name: 'admin-dashboard' }
      },
      {
        // 数据统计（5.5.1 新增，5.5.3 起同时是 /admin 的落地页；侧边栏排第一）
        //
